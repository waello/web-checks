...
const Results = (): JSX.Element => {
  ...
  return (
    <ResultsOuter>
      ...
      { address?.includes(window?.location?.hostname || 'web-checks.xyz') && <SelfScanMsg />}
      ...
      <FilterButtons>{ showFilters ? <>
        ...
        <span className="toggle-filters" onClick={() => setShowFilters(false)}>Hide</span>
          ...
          <div className="control-options">
            ...
            <a href="https://github.com/waello/web-checks"><span className="toggle-filters">View GitHub</span></a>
          </div>
      ) }
      </FilterButtons>
      <ResultsContent>
