  ...
  return (
    <HomeContainer>
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          <a href="https://github.com/waello/web-checks" title="Check out the source code and documentation on GitHub, and get support or contribute">
            <Button>View on GitHub</Button>
          </a>
          <a href="https://app.netlify.com/start/deploy?repository=https://github.com/waello/web-checks" title="Deploy your own private or public instance of Web-Check to Netlify">
